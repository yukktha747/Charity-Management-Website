    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('BN', 'Bangalore'), ('AX', 'Alexandria')], max_length=2)),
                ('marriageStatus', models.CharField(choices=[('MA', 'Married'), ('SN', 'Single'), ('WO', 'Widowed')], max_length=2)),
